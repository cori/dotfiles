...
#export OPENAI_API_HOST=http://localhost:2001
#export OPENAI_API_KEY=IAMGROOT
#export OPENAI_KEY=IAMGROOT
export OPENAI_KEY="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"
export OPENAI_API_KEY="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"
